...
export default class WorldScene extends Phaser.Scene {
  ...
  private enterTrain(): void { this.transitioning = true; this.player.freeze(); this.hud?.hideInteractionPrompt(); this.cameras.main.fadeOut(220, 0, 0, 0); this.cameras.main.once(Phaser.Cameras.Scene2D.Events.FADE_OUT_COMPLETE, () => this.scene.start('TrainInteriorScene', { day: this.day, season: this.season, tutorialStep: this.tutorialStep, returnPosition: { x: RETIRO_CONFIG.trainCoach.x + RETIRO_CONFIG.trainCoach.door.localX, y: RETIRO_CONFIG.trainCoach.y + RETIRO_CONFIG.trainCoach.door.localY, facing: 'down' } })); }
